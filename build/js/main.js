...
/***/ "./src/js/components/locomotiveScroll.js":
/*!***********************************************!*\
  !*** ./src/js/components/locomotiveScroll.js ***!
  \***********************************************/
/*! no exports provided */
...
/* harmony import */ var _preloader__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./preloader */ "./src/js/components/preloader.js");
...
function scrollInit() {
  ...
  scroll.on('scroll', function (func) {
    ...
    for (var index = 0; index < sections.length; index++) {
      ...
      if (scrollTop + window.innerHeight * 0.3 >= sectionTop) {
        ...
        var activeLink = document.querySelector('.js-scroll-to.is-active');
        var currentLink = document.querySelector(".js-scroll-to[href=\"#".concat(sectionId, "\"]"));
        if (activeLink) {
  ...
  if (progressEl) {
    var progressCircleEl = progressEl.querySelector('.js-progress-circle');
    var progressPercentEl = progressEl.querySelector('.js-progress-percent');
    if (backToTop) {
    ...
    scroll.on('scroll', function (_ref) {
      var limit = _ref.limit,
        scroll = _ref.scroll;
      var progress = (scroll.y / limit.y * 100).toFixed(0);
      var dasharray = "".concat(progress * 48 * 3 / 100, "px 450px");
      if (backToTop && _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$html.hasClass('has-scroll-smooth')) {
      ...
      if (progressPercentEl) {
        progressPercentEl.innerHTML = "".concat(progress, " %");
      }
      if (progressPercentEl) {
        progressPercentEl.setAttribute('style', "stroke-dasharray: ".concat(dasharray));
      }
    });
  }
}
_preloader__WEBPACK_IMPORTED_MODULE_2__["default"].init(scrollInit);
...
function init() {
  ...
  var maxWidth = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 991;
  /* 
  ...
  */
  ...
  if (!menu) return;
  var menuBurger = menu.querySelector('.js-menu-burger');
  var menuBody = menu.querySelector('.js-menu-body');
  var menuOverlay = menu.querySelector('.js-menu-overlay');
  var menuClose = menu.querySelector('.js-menu-close');
  var menuLinks = menu.querySelectorAll('.js-menu-link');
  var isMenu = true;
  if (menuBurger) {
  ...
  function openMenu() {
    if (isMenu) {
      ...
      _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$html.addClass('is-menu-active');
      setTimeout(function () {
        isMenu = true;
      }, delay);
    }
  ...
  function closeMenu() {
    if (isMenu) {
      ...
      _helpers__WEBPACK_IMPORTED_MODULE_0__["default"].$html.removeClass('is-menu-active');
      setTimeout(function () {
        isMenu = true;
      }, delay);
    }
...
var init = function init(callback) {
  ...
  var preloaderImage = $('.js-preloader-image');
  if (!preloader.length) {
    return;
  }
  var timeout = 800;
  ...
  if (imagesCount > 0) {
    var imgLoad = function imgLoad() {
      ...
      if (preloaderImage) {
        ...
        preloaderImage.css({
          '-webkit-transform': "translate(".concat(translateX, "px, ").concat(translateY, "px)"),
...
/* harmony import */ var _components_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/menu */ "./src/js/components/menu.js");
...
/* harmony import */ var _modules_backToTop__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/backToTop */ "./src/js/modules/backToTop.js");
/* harmony import */ var _components_locomotiveScroll__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/locomotiveScroll */ "./src/js/components/locomotiveScroll.js");
...
_modules_backToTop__WEBPACK_IMPORTED_MODULE_8__["default"].init();
_components_menu__WEBPACK_IMPORTED_MODULE_5__["default"].init(400, 1024);
// header.init();
